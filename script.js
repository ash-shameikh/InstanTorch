document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        ar: {
            page_title: "الشعلة السريعه - حلول مكافحة الحرائق",
            ...
            hero_title: "حماية , إنقاذ الأرواح",
            ...
            g3_title: "صيانة طفايات الحريق", g1_desc: "خدمات فحص وإعادة تعبئة دورية لجميع أنواع الطفايات.",
            g4_title: "خطط الإخلاء في حالات الطوارئ", g1_desc: "خطط إخلاء مخصصة ولوحات إرشادية للمباني التجارية والسكنية.",
            g5_title: "التدريب على السلامة من الحرائق", g1_desc: "برامج تدريب شاملة لموظفيك على الوقاية من الحرائق والاستجابة لها.",
            g6_title: "أنظمة فوهات الحريق", g1_desc: "تركيب واختبار أنظمة فوهات الحريق الرطبة والجافة.",
