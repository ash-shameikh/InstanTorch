...
window.addEventListener('scroll', function() {
    const frameTop = document.querySelector('.mil-frame-top');
    
    if (window.scrollY > 50) {
        frameTop.style.opacity = '0';
        frameTop.style.transform = 'translateY(-50px)';
        frameTop.style.transition = 'opacity 0.5s ease, transform 0.5s ease';
    } else {
        frameTop.style.opacity = '1';
        frameTop.style.transform = 'translateY(0)';
    }
});
